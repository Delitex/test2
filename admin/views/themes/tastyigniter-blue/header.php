    ...
    <div id="wrapper" class="<?php echo $wrapper_class; ?>">
		<nav class="navbar navbar-static-top navbar-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				<a class="hidden-xs sidebar-toggle" id="menu_toggle">
					<div class="navbar-brand">
						<div class="navbar-logo col-xs-3">
							<i class="fa <?php if($wrapper_class){echo "fa-indent";}else{echo "fa-outdent";} ?>" aria-hidden="true" style="margin-top: 10px; margin-left: 7px; color: white;"></i>
...
<!--							<li><a href="--><?php //echo site_url('uri_routes'); ?><!--">--><?php //echo lang('menu_uri_route'); ?><!--</a></li>-->
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu  dropdown-user">
                            ...
                            <li><a href="http://www.orderdime.com" target="_blank"><i class="fa fa-info-circle fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_about_tastyigniter'); ?></a></li>
							<li><a href="http://www.orderdime.com" target="_blank"><i class="fa fa-book fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_documentation'); ?></a></li>
							<li><a href="http://www.orderdime.com" target="_blank"><i class="fa fa-users fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_community_support'); ?></a></li>
