                        ...
                        <div class="cart-items">
                            <ul>
                                <?php foreach ($cart_items as $cart_item) { ?>
                                    <li>
                                        <a class="cart-btn remove text-muted small" onClick="removeCart('<?php echo $cart_item['menu_id']; ?>', '<?php echo $cart_item['rowid']; ?>', '0');"><i class="fa fa-times"></i></a>
                                        <a class="name-image" onClick="openMenuOptions('<?php echo $cart_item['menu_id']; ?>', '<?php echo $cart_item['rowid']; ?>', '<?php echo $cart_item['size_id']; ?>');">
...
<script type="text/javascript"><!--
    ...
    function addToCart(menu_id, quantity, size_id) {
        if ($('#menu-options' + menu_id).length) {
            ...
            var data = 'menu_id=' + menu_id + '&quantity=' + quantity + '&size_id=' + size_id;
        }
    ...
    function openMenuOptions(menu_id, row_id, size_id) {
        if (menu_id) {
            var row_id = (row_id) ? row_id : '';

            $.ajax({
                url: js_site_url('cart_module/cart_module/options?menu_id=' + menu_id + '&row_id=' + row_id + '&size_id=' + size_id),
                dataType: 'html',
