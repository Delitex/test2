...
class Checkout extends Main_Controller {
    ...
    public function check_order(){
        ...
        if($order_info['status_id']=='12' || $order_info['status_id']=='13' || $order_info['status_id']=='14' || $order_info['status_id']=='15'){
            echo "Your order has been confirmed!\nThank you for your order.";
        }
        elseif ($order_info['status_id']=='19') {
            echo "Sorry, but Your order has been canceled!";
        }
        else{
            echo '';
        }
